/**
 * Server-Side Groq Prompt Contract & Builder
 * 
 * Function-local module for Vercel Serverless runtime.
 * Prepares system and user messages containing ONLY structured InsightFacts.
 */

import type { InsightFacts } from '../../src/domain/insights/types';
